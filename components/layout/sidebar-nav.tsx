...
import { Home, Car, Sparkles, User, LogOut, Settings, Users, Swords, MessageSquare } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/talk",       icon: MessageSquare,  label: "Talk",       shortcut: "T" },
  { href: "/battle",     icon: Swords,         label: "Battle",     shortcut: "" },
