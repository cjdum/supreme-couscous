    ...
    return (
      <main className="min-h-dvh flex items-center justify-center px-4" style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(10,132,255,0.08) 0%, transparent 60%)" }}>
        <div className="w-full max-w-sm text-center animate-scale-in">
          <div className="w-16 h-16 rounded-[20px] bg-[var(--color-success-muted)] border border-[rgba(48,209,88,0.2)] flex items-center justify-center mx-auto mb-5">
          ...
          <p className="text-sm text-[var(--color-text-secondary)] max-w-xs mx-auto leading-relaxed">
            ...
            Click it to activate your account and access your garage.
          </p>
          <Link
            href="/login"
            className="inline-block mt-6 text-sm text-[var(--color-accent-bright)] hover:underline font-medium"
          >
            Back to sign in
          </Link>
        </div>
      ...
      <div className="w-full max-w-sm animate-in">
        ...
        <div className="rounded-[22px] border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            {serverError && (
              <div className="rounded-[10px] bg-[var(--color-danger-muted)] border border-[rgba(255,69,58,0.2)] px-4 py-3 text-sm text-[var(--color-danger)]" role="alert">
                {serverError}
              </div>
            )}
        ...
        <p className="text-center text-sm text-[var(--color-text-secondary)] mt-6">
          ...
          <Link href="/login" className="text-[var(--color-accent-bright)] hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
