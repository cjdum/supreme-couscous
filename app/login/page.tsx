    ...
    <main className="min-h-dvh flex items-center justify-center px-4 py-12" style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(10,132,255,0.08) 0%, transparent 60%)" }}>
      <div className="w-full max-w-sm animate-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-7 mb-1">Welcome back</h1>
        ...
        <div className="rounded-[22px] border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-xs text-[var(--color-text-muted)] hover:text-[var(--color-accent-bright)] transition-colors">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-[var(--color-text-secondary)] mt-6">
          ...
          <Link href="/signup" className="text-[var(--color-accent-bright)] hover:underline font-medium">
            Create one
          </Link>
        </p>
      </div>
